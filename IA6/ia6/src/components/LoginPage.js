...
class LoginPage extends React.Component {
    ...
    let data = localStorage.getItem("ismanagerUserData");
    if (data == null) { 
      //No user app data stored yet -- create blank record for current user
      localStorage.setItem("ismanagerUserData",
      JSON.stringify({[thisUser] : {"games" : {}, "gameCount": 0}}));  
    } else {
      ...
      if  (!data.hasOwnProperty(thisUser)) { 
          ...
          data[thisUser] = {"games": {}, "gameCount": 0}; 
    ...
    render() {
        ...
        <center>
            ...
            <p>
                <i>© 2020 Godfather of Intramurals. All rights reserved.</i>
            </p>
            </form>
        </center>
        </div>
